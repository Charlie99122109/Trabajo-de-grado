...
path = "C:/Users/Daniel Vargas/Documents/Tareas/Trabajo de Grado I/Transcripciones Páginas Web/"
...
def geturl(archivoenlaces):
    ...
    while True:
        ...
        convertirpaginasaimagenes(nombrepdf)
...
def convertirpaginasaimagenes(pdf_file):
    ...
    extraertextodeimagenes(filelimit)
...
def extraertextodeimagenes(filelimit):
    ...
    for i in range(1, filelimit + 1):
        ...
        contador += 1
        nombrearchivotxt = path + "PDF" + str(contador) + ".txt"
